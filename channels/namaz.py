...
def display_messages():
    ...
    messages = namaz_messages.find().sort('timestamp', pymongo.ASCENDING)
...
msj_entry=Entry(namazPage,width=50, font=("Arial", 15),bd=2, bg="sky blue", fg="black", relief=SUNKEN, justify=LEFT)
...
client = MongoClient('mongodb+srv://noorfatimaafzalbutt:0987654321@cluster0.qbhkxkc.mongodb.net/') 
db = client['Accord']
namaz_collection = db['namaz messages']
users_collection = db['users']

# Fetch messages from the 'namaz messages' collection
all_messages = namaz_collection.find({})
