...
def update_messages():
    messages = seerah_messages.find().sort([('timestamp', ASCENDING)])
...
messages_frame = Frame(seerahPage)
...
msj_entry=Entry(seerahPage,width=50, font=("Arial", 15),bd=2, bg="sky blue", fg="black", relief=SUNKEN, justify=CENTER)
