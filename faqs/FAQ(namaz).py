...
question1 = "Why is Salah important in Islam?"
...
question2 = "How many times a day do Muslims pray?"
...
question3 = "What is the significance of Friday Prayer (Jumu'ah)?"
...
question4 = "What is the role of the Adhan (call to prayer) in Salah?"
...
# help button
help_button=Button(time_frame,text="Help",font=("Arial", 15), bg="sky blue", fg="black",command=lambda: open_help("namaz_faq_page"))
