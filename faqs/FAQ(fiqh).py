...
namaz_frame = ttk.Frame(main_frame, style="RoundedFrame.TFrame")  # Changed fiqhPage to main_frame
...
header_frame = ttk.Frame(main_frame, style="RoundedFrame.TFrame")  # Changed fiqhPage to main_frame
