...
header_frame = ttk.Frame(main_frame, style="RoundedFrame.TFrame")  # Changed seerahPage to main_frame
header_frame.pack(side=TOP, padx=20)

header = Label(header_frame, text="FAQs about Seerah", font=("Arial", 20, "bold"), bg="sky blue", fg="black")
...
question1 = "Why is studying the Seerah important in Islam?"
...
answer1 = Label(frame1, text="Studying the Seerah is essential for Muslims to understand the life and teachings of Prophet Muhammad (S.A.W).", font=("Arial", 15), bg="sky blue", fg="black")
...
question2 = "How did Prophet Muhammad interact with other communities during his lifetime?"
...
answer2 = Label(frame2, text="Prophet Muhammad interacted with various tribes, emphasizing peaceful coexistence, justice, and dialogue.", font=("Arial", 15), bg="sky blue", fg="black")
...
question3 = "What were Prophet Muhammad's teachings and ethical principles?"
...
answer3 = Label(frame3, text="Monotheism, compassion, mercy, justice, honesty, humility, and social responsibility. ", font=("Arial", 15), bg="sky blue", fg="black")
...
question4 = "YWhat role did Prophet Muhammad play as a leader and statesman?"
...
answer4 = Label(frame4, text="Prophet Muhammad served as both a spiritual leader and a political statesman, guiding the Muslim community in every matter. ", font=("Arial", 15), bg="sky blue", fg="black")
