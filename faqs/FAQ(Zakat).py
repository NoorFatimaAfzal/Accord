...
db = client['Accord']
likes_collection = db['likes/dislikes(zakatFAQ)']
...
answer1 = Label(frame1, text="Zakat is the third pillar of Islam and is an obligatory charitable giving by Muslims. ", font=("Arial", 15), bg="sky blue", fg="black")
...
question2 = "What is the significance of Zakat in Islam?"
...
answer2 = Label(frame2, text="Zakat is considered a fundamental aspect of Islamic faith and serves multiple purposes.", font=("Arial", 15), bg="sky blue", fg="black")
...
question3 = "Who is obligated to pay Zakat?"
...
answer3 = Label(frame3, text="Muslims who possess wealth above a certain threshold (Nisab) for a full lunar year.", font=("Arial", 15), bg="sky blue", fg="black")
...
question4 = "Who are the recipients of Zakat?"
...
answer4 = Label(frame4, text="poor, needy, indebted, wayfarers, and those engaged in the collection and distribution of Zakat.", font=("Arial", 15), bg="sky blue", fg="black")
