...
header_frame = ttk.Frame(main_frame, style="RoundedFrame.TFrame")  # Changed hadithPage to main_frame
header_frame.pack(side=TOP, padx=20)

header = Label(header_frame, text="FAQs about Hadith", font=("Arial", 20, "bold"), bg="sky blue", fg="black")
...
# help button
help_button=Button(time_frame,text="Help",font=("Arial", 15), bg="sky blue", fg="black",command=lambda: open_help("hadith_faq_page"))
