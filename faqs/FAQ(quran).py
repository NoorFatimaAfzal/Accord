...
db = client['Accord']
likes_collection = db['likes/dislikes(quranFAQ)']
...
canvas = Canvas(quranPage)
scrollbar = Scrollbar(quranPage, command=canvas.yview)
...
header_frame = ttk.Frame(main_frame, style="RoundedFrame.TFrame")  # Changed quranPage to main_frame
header_frame.pack(side=TOP, padx=20)

header = Label(header_frame, text="FAQs about Quran", font=("Arial", 20, "bold"), bg="sky blue", fg="black")
...
question2 = "What language is the Quran written in?"
...
answer2 = Label(frame2, text="The Quran was revealed in classical Arabic, and it remains in its original language to this day.", font=("Arial", 15), bg="sky blue", fg="black")
...
question3 = "How is the Quran structured?"
...
question4 = "What is the significance of the Quran in Islam?"
...
answer4 = Label(frame4, text="The Quran is regarded as the ultimate source of guidance and wisdom for Muslims.", font=("Arial", 15), bg="sky blue", fg="black")
...
# help button
help_button=Button(time_frame,text="Help",font=("Arial", 15), bg="sky blue", fg="black",command=lambda: open_help("quran_faq_page"))
